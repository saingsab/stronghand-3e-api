...
-- :name get-all-users-with-level :? :*
SELECT u.ID, u.FIRST_NAME, u.MID_NAME, u.LAST_NAME, u.DESCRIPTION, u.EMAIL, u.GENDER, u.PROFILE_IMG, u.PHONENUMBER, l.LEVEL_DEC 
FROM USERS AS u
INNER JOIN USER_LEVEL as l
ON u.USER_LEVEL_ID = l.ID;

-- :name get-user-by-level :? :*
SELECT u.ID, u.FIRST_NAME, u.MID_NAME, u.LAST_NAME, u.DESCRIPTION, u.EMAIL, u.GENDER, u.PROFILE_IMG, u.PHONENUMBER, l.LEVEL_DEC 
FROM USERS AS u
INNER JOIN USER_LEVEL as l
ON u.USER_LEVEL_ID = l.ID
WHERE l.ID = :USER_LEVEL_ID;

-- :name update-user-level :! :n
UPDATE USERS
